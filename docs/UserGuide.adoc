...
* Valid Arguments are: 'name', 'number', 'address', 'email', 'remark', 'birthday', favourite.
* CamelCase arguments are allowed 'NamE', 'NuMbEr', 'AddResS, 'EmAIL', 'REMARK', 'BiRtHDAY', 'FavouRITE'
****
