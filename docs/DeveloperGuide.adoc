...
|`* * *` |user |sort the contact list by Name/contact number | make sense of the data
...
|`* *` |user |see the most commonly accessed persons on my addressbook when I first startup | quickly access the most commonly used persons without having to manually search
...
|`*` |user |be able to change the colorscheme of the GUI app | choose my favorite colorscheme instead of always being stuck with the dark theme
...
.  Latest version should be prompted to download every month.
...
.  User should be able to inituitively learn the application of AddressBook with ease (No need to refer to helpguide for every usage)
.  Colour contrast should be optimal for even color-blind patients.
...
* Inituitive User Interface - No words needed for use to know how to find/ add / delete persons
* Large amount of contacts storable - Caters for people with alot of Contacts
